...
var lt = defineComponent({
  ...
  setup(e2, { emit: t2 }) {
    const r = computed(
      ...
      const g = new Date(), v = r.value(e2.format);
...
var rt = defineComponent({
  ...
  setup(e2, { emit: t2 }) {
    const r = ref(null), l = ref(null), o = computed(() => {
      var _a;
      return (_a = e2.pageDate) != null ? _a : e2.selected;
    }), p = ref(o.value.getHours()), n = ref(o.value.getMinutes());
    watch(
      () => e2.selected,
      (i2) => {
        let D2 = 0, g = 0;
...
var vt = defineComponent({
  ...
  setup(e2, { emit: t2, attrs: r }) {
    ...
    watchEffect(() => {
      const s3 = parse(a3.value, e2.inputFormat, new Date(), {
        locale: e2.locale
      });
